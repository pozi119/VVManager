...
- (VVHop *(^)(VVHopMethod method))vv_method;

- (VVHop *(^)(UIViewController *controller))vv_controller;

- (VVHop *(^)(NSString *aController))vv_aController;

- (VVHop *(^)(NSString *aStoryboard))vv_aStoryboard;

- (VVHop *(^)(NSDictionary *parameters))vv_parameters;

- (VVHop *(^)(void (^completion)(void)))vv_completion;

- (VVHop *(^)(BOOL sourceInNavi))vv_sourceInNavi;

- (VVHop *(^)(BOOL destInNavi))vv_destInNavi;

- (VVHop *(^)(CGFloat alpha))vv_alpha;

- (VVHop *(^)(BOOL animated))vv_animated;

- (VVHop *(^)(NSArray *removeVCs))vv_removeVCs;

- (VVHop *(^)(BOOL showBottomBarWhenPushed))vv_showBottomBarWhenPushed;
