...
NSNotificationName const VVManagerViewDidAppearNotification = @"VVManagerViewDidAppearNotification";
NSNotificationName const VVManagerViewDidDisappearNotification = @"VVManagerViewDidDisappearNotification";
...
- (void)appearController:(UIViewController *)viewController{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:VVManagerViewDidAppearNotification object:viewController];
    if(!_appearFlag){
...
- (void)disappearController:(UIViewController *)viewController{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:VVManagerViewDidDisappearNotification object:viewController];
...
+ (void)setVerbose:(BOOL)verbose{
    [VVManager sharedManager].verbose = verbose;
}
