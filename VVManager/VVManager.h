...
UIKIT_EXTERN NSNotificationName const VVManagerViewDidAppearNotification;
UIKIT_EXTERN NSNotificationName const VVManagerViewDidDisappearNotification;
...
/**
 *  重置,清除所有保存的UIViewController和UINavigationController.
 *  在某些特殊场景使用,比如重新设置了UIApplication的KeyWindow
 */
+ (void)reset;
